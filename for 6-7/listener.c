...
int main(int argc, char **argv) {
    ...
    while (1) {
        ...
        if ((recv_len = recvfrom(server_sock, (void*)&buffer, BUFSIZE, 0, (struct sockaddr *)&client_addr, &client_len)) < 0) {
            error_handler("Failed to receive packet.");
        }


        // Код для вывода информации о состоянии разных частей программ:
        printf("------------------------------------------------------\n");
